...
struct poly {
    double *data;
    int size;//how much space is allocated to it
    int length;//largest index of number. can be of size 10, length 5
};
...
void polyPrint (struct poly *p); //- Prints the polynomial in the format illustrated below. You may reuse your A4P2 submission.
