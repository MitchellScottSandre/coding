...
void SBL_init (SBL& sbl) {
	...
	sbl.order = newOrder;
	sbl.numPeople = 0;
	//could also just do BST_init(sbl.names)
}
...
int main (int argc, char* argv[]) {
	SBL sss;
	SBL_init(sss);
	SBL_arrive(sss, "aaa_1");

	cout << "printing in order" << endl;
	SBL_printInArrivalOrder(sss);

	cout << "printing lexicographically" << endl;
	SBL_printInLexicographicalOrder(sss);

	cout << "size of sss is " << SBL_size(sss) << endl;

	SBL_leave(sss);

	cout << "just called leave " << endl;
	...
	// SBL_arrive(sss, "bbb_2");
	// SBL_arrive(sss, "zzz_3");
	// SBL_arrive(sss, "kkk_4");
	// SBL_arrive(sss, "aaa_5");
	// SBL_arrive(sss, "jjj_6");
	// SBL_arrive(sss, "ttt_7");
	// SBL_arrive(sss, "vvv_8");
	// SBL_arrive(sss, "ooo_9");
	//
	// cout << "size of sss is " << SBL_size(sss) << endl;
	//
	// cout << "sss first is " << SBL_first(sss) << endl;
	//
	// cout << "printing in order" << endl;
	// SBL_printInArrivalOrder(sss);
	//
	...
	// SBL_printInLexicographicalOrder(sss);
	//
	// cout << "calling SBL_leave" << endl;
	// SBL_leave(sss);
	// cout << "Now printing in order again" << endl;
	// SBL_printInArrivalOrder(sss);
