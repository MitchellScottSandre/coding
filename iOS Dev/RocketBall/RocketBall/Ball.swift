...
class Ball{
    ...
    init(radius: CGFloat, fillColor: SKColor, strokeColor: SKColor, startX: CGFloat, startY: CGFloat){
        ...
        self.node.physicsBody?.contactTestBitMask = PhysicsCategory.Paddle | PhysicsCategory.ScoreRegions[0] | PhysicsCategory.ScoreRegions[1] | PhysicsCategory.ScoreRegions[2] | PhysicsCategory.ScoreRegions[3]
